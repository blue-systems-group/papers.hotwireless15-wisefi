...
\def\theemails{\texttt{\{jinghaos,liwengui,qiao,dimitrio,challen\}@buffalo.edu}}
\def\thepapernumber{5}
...
\author{
  Jinghao Shi, Liwen Gui, Chunming Qiao\\
  Dimitrios Koutsonikolas, and Geoffrey Challen\\ [2mm]
